...
name_label = Label(window, text="Rate of Interest", fg="black", bg="lightcyan", font=("Calibri", 12), bd=1)
...
time_label = Label(window, text="Enter time (cm)", fg="black", bg="lightcyan", font=("Calibri", 12))
time_label.place(x=20, y=140)

time_entry = Entry(window, text="", bd=2, width=15)
time_entry.place(x=150, y=142)

rateofinterest_label = Label(window, text="rate of interest", fg="black", bg="lightcyan", font=("Calibri", 12))
